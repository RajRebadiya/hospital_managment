                ...
                <div class="">
                    <form action="{{ route('add_appointment') }}" method="POST">
                        ...
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
                            ...
                            {{-- <input type="hidden" name="patient_id" value='{{ $user_id }}' placeholder="name" /> --}}
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="date" id="date-of-birth" name="app_date" value="{{ old('app_date') }}"
                        ...
                        <div>
                            <label for="date-of-birth">Appointment Time :</label>
                            <input type="time" id="date-of-birth" name="app_time" value="{{ old('app_time') }}">
                            @error('app_time')
                                <div class="alert alert-danger" style="color: red">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        @endphp
                        <div>
                            <label for="gender">Select Doctor :</label><br>
